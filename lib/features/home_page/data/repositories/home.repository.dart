...
class HomeRepository implements IHomeRepository {
 ...
 try {
  ...
  try {
      final response = await _apiService.get("user/all-users/$distance");
      return response;
    } catch (e) {
      rethrow;
    }
  ...
  try {
      final response = await _apiService.post("melt/like",
      body: {
  ...
  Future<Responses> unLikeUser( {required String userToLike}) async {
    try {
      final response = await _apiService.post("melt/unlike",
      body: {
        "userToLike": userToLike,
      });
 ...
 try {
      final response = await _apiService.post("melt/unmelt",
      body: {
        "userToMelt": userToMelt,
      });
      return response;
