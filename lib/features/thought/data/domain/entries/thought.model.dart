...
class ThoughtModel {
  ...
  final String? audioUrl; // present when type = voice
  final int? audioDuration; // seconds, present when type = voice
  ...
  /// Creates a copy of this ThoughtModel with updated communityMetadata
  /// Useful for syncing metadata when community details change
  ThoughtModel copyWithCommunityMetadata(
      CommunityMetadata? newCommunityMetadata) {
    return ThoughtModel(
      id: id,
      userId: userId,
      content: content,
