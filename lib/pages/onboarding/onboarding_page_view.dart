    ...
    void nextPage() {
      setState(() {
        if (_controller.page == 2) {
         // AnalyticsService().sendFirebaseAnalyticsEvent('user_completes_tour');
        ...
        children: [
          ...
          buttonText: 'Sign up with your email' ,
            ...
            Wrap(
              ...
              children: [
                TextView(text: 'By tapping Sign up or Log in, you agree to our ', fontSize: 10,),
                TextView(text: 'Terms', fontSize: 10, fontWeight: FontWeight.bold,),
                TextView(text: 'Learn how we process your data in our ',fontSize: 10, fontWeight: FontWeight.normal,),
                TextView(text: 'Privacy Policy',fontSize: 10, fontWeight: FontWeight.bold,),
                TextView(text: ' and ',fontSize: 10, fontWeight: FontWeight.normal,),
                TextView(text: 'Cookies Policy',fontSize: 10, fontWeight: FontWeight.bold,),
              ],
            )
