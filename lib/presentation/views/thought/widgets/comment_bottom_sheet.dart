...
class _CommentBottomSheetState extends ConsumerState<CommentBottomSheet> {
  ...
  void _scrollToComment(String commentId) {
    ...
    final commentsState = ref.read(commentViewModelProvider(widget.thought.id));
  ...
  Widget build(BuildContext context) {
    final commentsState = ref.watch(commentViewModelProvider(widget.thought.id));
        ...
        children: [
          ...
          Expanded(
            child: RefreshIndicator(
              onRefresh: () async {
                await ref
                    .read(commentViewModelProvider(widget.thought.id).notifier)
                    .refresh();
              },
                      ...
                      : commentsState.comments.isEmpty
                          ...
                          : Builder(
                              builder: (context) {
                                ...
                                final topLevelComments = commentsState.comments
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    final replies = commentsState.comments
                                        .where((c) =>
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: TextView(
                              text:
                                  "Replying to ${_replyingToComment!.content}",
                              fontSize: 14,
                              color: const Color(0xFFD2128B),
